...
class ReceivingAdapter(
    private var receivingList: List<ReceivingView>,
    private val clickListener: (item: ReceivingView) -> Unit
) :
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        val card: CardView = itemView.findViewById(R.id.card_receiving_card)
